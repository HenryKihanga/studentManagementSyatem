  ...
  <div class="row">
    <div class="col-2 sidebar">
      ...
      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        <a class="nav-link text-white active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-studentRegistration" role="tab" aria-controls="v-pills-home" aria-selected="true">Student Registration</a>
        <a class="nav-link text-white" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">View all Students</a>
    ...
    <div class="col-10">
      ...
      <div class="tab-content" id="v-pills-tabContent">
        ...
        <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
          <?php
        //   if (isset($_SESSION['individualStudent'])) {
        //     include('./includes/sharedScreens/studentDetails.php');
        //   } else {
        //     include('./includes/sharedScreens/viewAllStudentsScreen.php');
        //   }
          ?>
        </div>
        ...
        <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
          <?php
        //   include('./includes/maleziSubScreens/suspendedBlacklistedScreen.php');
          ?>
        </div>
        ...
        <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
          <?php
            // include('./includes/maleziSubScreens/punishedStudentsScreen.php');
             ?>
        </div>
        ...
        <div class="tab-pane fade" id="v-pills-details" role="tabpanel" aria-labelledby="v-pills-details-tab">
          <?php
            // include('./includes/sharedScreens/userDetailsScreen.php');
            ?>
        </div>
      </div>
    </div>
