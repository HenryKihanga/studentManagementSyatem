       ...
       <div class="card-body">
         <form action="./maleziPage.php" method="POST" enctype="multipart/form-data">
           ...
           <div class="form-group row">
             ...
             <div class="col-sm-9">
               <input type="file" class="form-control-file" id="studentProfilePicture" name="studentProfilePicture" value="">
             </div>
           </div>
           ...
           <div class="form-row">
             <div class="form-group col-md-6">
               <div class="row">
                 ...
                 <div class="col-md-8">
                   <input type="file" class="form-control-file" id="birthCertificate" name="studentBirthCertificate" value="">
                 </div>
               </div>
             </div>
             <div class=" form-group col-md-6">
               <div class="row">
                 ...
                 <div class="col-md-8">
                   <input type="file" class="form-control-file" id="academicCertificate" name="studentAcademicCertificate" value="">
                 </div>
               </div>
             </div>
           </div>
           ...
           <div class="form-row ">
             <div class="form-group col-md-6">
               <div class="row">
                 ...
                 <div class="col-md-8">
                   <input type="file" class="form-control-file" id="healthReport" name="studentHealthReport" value="">
                 </div>
               </div>
             </div>
             ...
             <div class=" form-group col-md-6">
               <div class="row">
                 ...
                 <div class="col-md-8">
                   <input type="file" class="form-control-file" id="bankPayinSlip" name="studentBankPayinSlip" value="">
                 </div>
               </div>
             </div>
           ...
           <div class=" form-group row">
             ...
             <div class="col-sm-9">
               <textarea class="form-control" id="studentDescription" name="studentDescription" cols="30" rows="2" placeholder="Describe student here" value=""></textarea>
                   </div>
                 </div>

                 <!-- submit button -->
                 <button type=" submit" name="submitStudentData" class="btn btn-info">SUBMIT THEN AND PARENT INFO</button>
         </form>
       </div>
     </div>
   </div>
